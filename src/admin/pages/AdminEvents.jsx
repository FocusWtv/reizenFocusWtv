  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg" onClick={() => { setEditingId(null); setNewEvent({ title: '', slug: '', date: '', imageUrl: '', relatedCardSlug: '', locationName: '', address: '', description: '', contactPhoneLabel: '', contactPhone: '', contactEmailLabel: '', contactEmail: '', contactText: '' }); setSelectedCardId(''); setSlugTouched(false); }}>
          Nieuw
        </button>
      </div>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">Contacttekst (onder formulier)
            </label>
            <textarea rows={5} value={newEvent.contactText} onChange={(e) => setNewEvent(v => ({ ...v, contactText: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Tekst onder het formulier (je kunt links/telefoons inplakken)" />
          </div>
        </div>
